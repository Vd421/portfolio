import { Bot, Zap, Eye, Leaf, Flame, Plus, ArrowRight } from "lucide-react";
...
export default function Projects() {
  const projects = [
    ...
    },
    {
      ...
      icon: <Zap className="text-emerald-600 text-2xl" />,
      ...
      techBg: "bg-emerald-100",
      techText: "text-emerald-800"
    },
    {
      title: "AI Blind Stick",
      icon: <Eye className="text-purple-600 text-2xl" />,
    ...
    },
    {
      ...
      icon: <Leaf className="text-yellow-600 text-2xl" />,
      ...
      techBg: "bg-yellow-100",
      techText: "text-yellow-800"
    },
    {
      title: "Arduino Fire Fighter Bot",
      icon: <Flame className="text-red-600 text-2xl" />,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <div key={index} className={`bg-gradient-to-br ${project.gradient} rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-slate-100`}>
              <div className="flex items-center mb-4">
                {project.icon}
                <h3 className="text-xl font-semibold text-slate-800 ml-3">{project.title}</h3>
              </div>
              <div className="mb-4">
          ...
          <div className="bg-gradient-to-br from-indigo-50 to-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-slate-100">
            <div className="flex items-center mb-4">
              <Plus className="text-indigo-600 text-2xl" />
              <h3 className="text-xl font-semibold text-slate-800 ml-3">More Projects</h3>
            </div>
            <p className="text-slate-600 text-sm leading-relaxed">
